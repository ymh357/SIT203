	...
	*/			
	...
	function quickSort(products,seq) {
		...
		*/
		...
		var pivot = products.splice(pivotIndex, 1)[0];
		var left = new Array();
		var right = new Array();
		if(seq=="low-high"){				
	...
	$(document).ready(function(){
		...
		currentDisplayedItems=null;	// Products currently shown in div. Each element without certain sequence.
		...
		$("#applyBtn").click(function(){
			/*
				...
				4. Change currentDisplayedItems and beforeDevidedItems.
		...
		$("#ladyTShirt").click(function(){
			
			// Anchor towards content inside current page will not reload the page; So reload the page manually.  
			category=$("#ladyTShirt").attr("href").split("#")[1];
			document.location.replace("category-lady.html#"+category);
			location.reload();
			return false;
		});
		$("#ladyShirt").click(function(){
			// Anchor towards content inside current page will not reload the page; So reload the page manually.  
			// document.location.reload();
			category=$("#ladyShirt").attr("href").split("#")[1];
			document.location.replace("category-lady.html#"+category);
			location.reload();
			return false;
		});
		$("#ladyPants").click(function(){
			// Anchor towards content inside current page will not reload the page; So reload the page manually.  
			// document.location.reload();
			category=$("#ladyPants").attr("href").split("#")[1];
			document.location.replace("category-lady.html#"+category);
			location.reload();
			return false;
		});
		$("#ladyAccessory").click(function(){
			// Anchor towards content inside current page will not reload the page; So reload the page manually.  
			// document.location.reload();
			category=$("#ladyAccessory").attr("href").split("#")[1];
			document.location.replace("category-lady.html#"+category);
			location.reload();
			return false;
		});
		
		$("#topLadyTShirt").click(function(){
			// Anchor towards content inside current page will not reload the page; So reload the page manually.  
			// document.location.reload();
			category=$("#topLadyTShirt").attr("href").split("#")[1];
			document.location.replace("category-lady.html#"+category);
			location.reload();
			return false;
		});
		$("#topLadyShirt").click(function(){
			// Anchor towards content inside current page will not reload the page; So reload the page manually.  
			// document.location.reload();
			category=$("#topLadyShirt").attr("href").split("#")[1];
			document.location.replace("category-lady.html#"+category);
			location.reload();
			return false;
		});
		$("#topLadyPants").click(function(){
			// Anchor towards content inside current page will not reload the page; So reload the page manually.  
			// document.location.reload();
			category=$("#topLadyPants").attr("href").split("#")[1];
			
			showProducts(category);
			return false;
		});
		$("#bottomLadyTShirt").click(function(){
			// Anchor towards content inside current page will not reload the page; So reload the page manually.  
			// document.location.reload();
			category=$("#bottomLadyTShirt").attr("href").split("#")[1];
			
			showProducts(category);
			return false;
		});
		$("#bottomLadyShirt").click(function(){
			// Anchor towards content inside current page will not reload the page; So reload the page manually.  
			// document.location.reload();
			category=$("#bottomLadyShirt").attr("href").split("#")[1];
			document.location.replace("category-lady.html#"+category);
			location.reload();
			return false;
		});
		$("#bottomLadyPants").click(function(){
			// Anchor towards content inside current page will not reload the page; So reload the page manually.  
			// document.location.reload();
			category=$("#bottomLadyPants").attr("href").split("#")[1];
			document.location.replace("category-lady.html#"+category);
			location.reload();
			return false;
		});
		
		$("#ladyBag").click(function(){
			// Anchor towards content inside current page will not reload the page; So reload the page manually.  
			// document.location.reload();
			category=$("#ladyBag").attr("href").split("#")[1];
			document.location.replace("category-lady.html#"+category);
			location.reload();
			return false;
		});
		$("#ladyBelt").click(function(){
			// Anchor towards content inside current page will not reload the page; So reload the page manually.  
			// document.location.reload();
			category=$("#ladyBelt").attr("href").split("#")[1];
			document.location.replace("category-lady.html#"+category);
			location.reload();
			return false;
		});  
